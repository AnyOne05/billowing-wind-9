"""
Django settings for billowing_wind_9 project.
...
ROOT_URLCONF = 'billowing_wind_9.urls'
...
WSGI_APPLICATION = 'billowing_wind_9.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Billowing Wind Support <support@billowing-wind-9.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "billowing_wind_9 API",
    "DESCRIPTION": "API documentation for billowing_wind_9 App",
    "VERSION": "v1",
}
